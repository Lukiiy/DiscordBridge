...
public class Console implements CommandPlate {
    @Override
    public @NotNull CommandData command() {
    ...
    public void interaction(CommandInteraction i) {
        ...
        Bukkit.getScheduler().runTask(instance, () -> Bukkit.dispatchCommand(Bukkit.getConsoleSender(), fCmd));
        instance.getLogger().info(member.getEffectiveName() + " executed \"/" + cmd + "\" as console.");
